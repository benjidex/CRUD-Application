  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: priority.color, opacity: 0.8,
      }} />

      {/* Top row */}
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '12px' }}>
        <h3 style={{
          fontSize: '0.95rem', fontFamily: 'var(--font-body)', fontWeight: 600,
          ...
          {confirmDelete ? (
            <>
              <button onClick={() => onDelete(task.id)} style={{
                ...
                background: 'var(--red)', color: '#fff', fontSize: '0.72rem', fontWeight: 700,
              }}>DELETE</button>
              <button onClick={() => setConfirmDelete(false)} style={{
                padding: '0 10px', height: '28px', borderRadius: '6px',
                background: 'var(--surface2)', color: 'var(--text-muted)', fontSize: '0.72rem',
              }}>CANCEL</button>
            </>
          ) : (
